                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-6">
                        <div class="icon_box icon_box_style4 box_shadow1" style="border-radius: 18px">
                            <div class="icon">
                                <img src="{{asset('frontend/assets/images/theme/icons/icon-1.svg')}}" height="100"
                                     width="100">
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="icon_box icon_box_style4 box_shadow1" style="border-radius: 18px">
                            <div class="icon">
                                <img src="{{asset('frontend/assets/images/theme/icons/icon-2.svg')}}" height="100"
                                     width="100">
                            </div>
                            <div class="icon_box_content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="icon_box icon_box_style4 box_shadow1" style="border-radius: 18px">
                            <div class="icon">
                                <img src="{{asset('frontend/assets/images/theme/icons/icon-3.svg')}}" height="100"
                                     width="100">
                            </div>
                            <div class="icon_box_content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="icon_box icon_box_style4 box_shadow1" style="border-radius: 18px">
                            <div class="icon">
                                <img src="{{asset('frontend/assets/images/theme/icons/icon-4.svg')}}" height="100"
                                     width="100">
                            </div>
                            <div class="icon_box_content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="icon_box icon_box_style4 box_shadow1" style="border-radius: 18px">
                            <div class="icon">
                                <img src="{{asset('frontend/assets/images/theme/icons/icon-5.svg')}}" height="100"
                                     width="100">
                            </div>
                            <div class="icon_box_content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="icon_box icon_box_style4 box_shadow1" style="border-radius: 18px">
                            <div class="icon">
                                <img src="{{asset('frontend/assets/images/theme/icons/icon-6.svg')}}" height="100"
                                     width="100">
                            </div>
                            <div class="icon_box_content">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about_img scene mb-4 mb-lg-0">
                            <img
                                src="{{asset('frontend/assets/images/demo_user.jpg')}}"
