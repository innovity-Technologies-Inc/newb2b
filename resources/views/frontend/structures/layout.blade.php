...
<head>
    ...
    <!-- Favicon Icon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('frontend/assets/images/deshi-shad-favicon.png')}}">
    <!-- Animation CSS -->
...
<script>
    ...
    const hasSecondLayerToken = {{ session()->has('second_layer_token') ? 'true' : 'false' }};
