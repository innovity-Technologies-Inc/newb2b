                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about_img scene mb-4 mb-lg-0">
                            <img src="<?php echo e(asset('frontend/assets/images/page/vision.jpg')); ?>" style="border-radius: 14px" alt="about_img">
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="section">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about_img scene mb-4 mb-lg-0">
                            <img src="<?php echo e(asset('frontend/assets/images/page/mission.jpg')); ?>" style="border-radius: 14px" alt="about_img">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about_img scene mb-4 mb-lg-0">
                            <img src="<?php echo e(asset('frontend/assets/images/page/values.jpg')); ?>" style="border-radius: 14px" alt="about_img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="heading_s1">
...
<?php echo $__env->make('frontend.structures.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Web\b2b_ecommerce\resources\views\frontend\vision_mission_values.blade.php ENDPATH**/ ?>