...
<head>
    ...
    <!-- SITE TITLE -->
    <title>Deshi Shad</title>
    <!-- Favicon Icon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('frontend/assets/images/deshi-shad-favicon.png')); ?>">
    <!-- Animation CSS -->
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Ubuntu+Sans+Mono:ital,wght@0,400..700;1,400..700&display=swap" rel="stylesheet">
    <!-- Icon Font CSS -->
...
<!-- Latest jQuery -->
<script src="<?php echo e(asset('frontend/assets/js/jquery-3.7.0.min.js')); ?>"></script>
...
<script>
    $('#cartUpdate').click(function(event) {
        ...
        Swal.fire({
            title: 'Are you sure you want to update the cart item?',
            text: 'You won\'t be able to revert this!',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
...
<script>
    $('.removeCart').click(function(event) {
        ...
        Swal.fire({
            title: 'Are you sure you want to remove the item from the cart?',
            text: 'You won\'t be able to revert this!',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
...
<!-- Waypoints (required by counterUp) -->
...
<!-- Snacks Section Swiper -->
<script>
    var swiper = new Swiper(".snackSwiper", {
        grabCursor: true,
...
<!-- Dry Food Section Swiper -->
<script>
    var swiper = new Swiper('.dryFoodSwiper', {
        grabCursor: true,
        centeredSlides: false,
        slidesPerView: 3,
        spaceBetween: 0,
...
<!-- Grain Section Swiper -->
<script>
    var swiper = new Swiper(".grainSwiper", {
        effect: "creative",
        creativeEffect: {
            prev: {
                shadow: true,
        ...
        centeredSlides: false,
        slidesPerView: 2,
        spaceBetween: 30,            // Remove space between slides if desired
        loop: true,                 // Optional
        speed: 2000,
        autoplay: {
            delay: 1000,
...
<!-- Vegetables Section Swiper -->
<script>
    var swiper = new Swiper(".vegetableSwiper", {
        loop: true,
        slidesPerView: 3,
        spaceBetween: 16,                // Adjust spacing as needed
        speed: 6000,                     // Higher = slower scroll
        autoplay: {
            delay: 0,                      // No pause between scrolls
            disableOnInteraction: false,  // Keep rolling after interaction
        },
        freeMode: true,                  // Continuous smooth scroll
        freeModeMomentum: false,         // Disable momentum snapping
        allowTouchMove: false,          // Optional: prevent swipe
    });
</script>
...
<script>
    AOS.init({
        ...
        once: false,            // false = repeat every scroll into view
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (showPasswordCheckbox) {
            showPasswordCheckbox.addEventListener('click', function () {
                ...
                if (newPasswordInput) newPasswordInput.type = newType;
                if (oldPasswordInput) oldPasswordInput.type = newType;
...
<?php /**PATH D:\Project\Web\b2b_ecommerce\resources\views/frontend/structures/layout.blade.php ENDPATH**/ ?>